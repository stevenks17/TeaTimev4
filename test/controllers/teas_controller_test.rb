...
class TeasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tea" do
    assert_difference('Tea.count') do
      post teas_url, params: { tea: { brand_id: @tea.brand_id, description: @tea.description, flavor: @tea.flavor } }
    end
  ...
  test "should update tea" do
    patch tea_url(@tea), params: { tea: { brand_id: @tea.brand_id, description: @tea.description, flavor: @tea.flavor } }
